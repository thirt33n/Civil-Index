...
<html>
	...
	<body class="Loggedin">
		...
		<nav id="navbar" class="navbar">
			...
			<a href="pendingLists.php"><i class="fa-sharp fa-solid fa-i"></i>Indexes</a>
		...
		<div class="content">
			<h2>Welcome Home, <?=$_SESSION['name']?>! You have additional Privileges</h2>
		</div>
			...
			<div class="card-body">
				<form action="addinfo.php" method="post" autocomplete="off">
					<div class="input-group form-group">
						...
						<input type="number" name="area" id="area" class="form-control" placeholder="Enter Surface Area" required>
